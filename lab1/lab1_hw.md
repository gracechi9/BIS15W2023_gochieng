...
RStudio is a GUI that allows working in R to be easier. Gifthub is the place where programmers can collaborate on software projects store and create code files 
